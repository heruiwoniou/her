...
function relativeTo() {
  ...
  // Resolve path
  var path$$1 = r.apply(undefined, _toConsumableArray(args));
...
var assign = _createAssigner(function(object, source) {
  ...
  for (var key in source) {
    if (hasOwnProperty$14.call(source, key)) {
...
var Builder = function () {
  function Builder(her) {
    ...
    // 模板文件夹
    this.templateRoot = path.join(__dirname, "../lib/app");
    // 目标文件夹
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _Promise.all(["tpl/components/content.vue", fs.existsSync(path.resolve(this.her.defaultOptions.srcDir, "layouts/error.vue")) ? "src/layouts/error.vue" : "tpl/components/error.vue", "tpl/components/loading.vue", "tpl/entryFactory.js", "tpl/utils.js"].map(function () {
                  var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(fileName) {
                    var path$$1, tpl, compiler;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            path$$1 = fileName.indexOf("src/") > -1 ? path.join(_this.her.defaultOptions.srcDir, fileName.replace("src/", "")) : path.join(_this.templateRoot, fileName.replace("tpl/", ""));

                            fileName = fileName.indexOf("src/") > -1 ? fileName.substr(fileName.indexOf("/") + 1, fileName.length).replace("layouts", "components") : fileName.substr(fileName.indexOf("/") + 1, fileName.length);
                            _context3.next = 4;
                            return fs.readFile(path$$1, "utf-8");
                      ...
                      while (1) {
                        switch (_context8.prev = _context8.next) {
                          ...
                          case 2:
                            ...
                            res = filter_1(res, function (file) {
                              return file.indexOf("page_components") == -1;
                            });
                            _this4.routers.push({
                              entryName: entryName,
                          ...
                          case 2:
                            ...
                            compiler = template_1(tpl, {
                              imports: {
                                ...
                                wp: wp,
                                wChunk: wChunk,
                                relativeToBuild: function relativeToBuild() {
                                  for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                                    args[_key] = arguments[_key];
                                  }

                                  return relativeTo.apply(undefined, [path.join(_this5.generateAppRoot, "entries", entryName)].concat(args));
                                }
                              }
                            });
                            _context10.next = 6;
                            return fs.writeFile(path.join(_this5.generateAppRoot, "entries", entryName, "router.js"), compiler(assign_1({ entryName: entryName, router: { routes: router } }, {
                              uniqBy: uniqBy_1
                            })), "utf-8");
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 7:
                ...
                filter_1(layoutsFiles, function (file) {
                  return file.indexOf("layout_components") == -1;
                }).forEach(function (file) {
                  var name = file.split("/").slice(1).join("/").replace(/\.vue$/, "");
                  if (name === "error") {
                    return;
                  }
                  _this6.layouts[name] = relativeToBuild(_this6.her.defaultOptions.srcDir, file);
                });
...
function babelOption(baseOption) {
  var ret = defaultsDeep_1(baseOption.webpack.babel, {
    babelrc: false,
...
function styleLoader(baseOption, ext) {
  ...
  loaders = (Array.isArray(loaders) ? loaders : [loaders]).map(function (loader) {
    var options = baseOption.webpack.styleLoader[loader.loader || loader] || {};
...
function vueLoader(baseOption, builderOption) {
  return {
    ...
    loaders: {
      ...
      'scss': styleLoader(baseOption, 'scss', ['sass-loader', 'sass-resources-loader'], true),
      'sass': styleLoader(baseOption, 'sass', [{ loader: 'sass-loader', options: { indentedSyntax: true } }, 'sass-resources-loader'], true),
...
var configFactory = function (baseOption, builderOption) {
  return {
    ...
    resolve: defaultsDeep_1(baseOption.webpack.resolve, {
    ...
    module: {
      ...
      rules: [{
        ...
        options: babelOption(baseOption)
      }, { test: /\.css$/, use: styleLoader(baseOption, 'css') }, { test: /\.less$/, use: styleLoader(baseOption, 'less', 'less-loader') }, { test: /\.sass$/, use: styleLoader(baseOption, 'sass', [{ loader: 'sass-loader', options: { indentedSyntax: true } }, 'sass-resources-loader']) }, { test: /\.scss$/, use: styleLoader(baseOption, 'scss', ['sass-loader', 'sass-resources-loader']) }, { test: /\.styl(us)?$/, use: styleLoader(baseOption, 'stylus', 'stylus-loader') }, {
      ...
      }].concat(_toConsumableArray(baseOption.webpack.rules))
    },
    ...
    new webpack.DefinePlugin({
      ...
      name: 'manifest',
      chunks: ['vendor']
    }), new CopyWebpackPlugin(baseOption.statics.map(function (s) {
      return {
        from: path.resolve(baseOption.rootDir, s),
        to: s,
        ignore: ['.*']
      };
      ...
      threshold: 10240,
      minRatio: 0.8
    })] : []))), _toConsumableArray(baseOption.webpack.plugins))
  };
};
...
var Server = function () {
  ...
  _createClass(Server, [{
    key: "buildWebpack",
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        var _this = this;
              ...
              case 0:
                ...
                return _Promise.all(this.compilers.map(function (compiler) {
                  return new _Promise(function () {
                    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(resolve$$1, reject) {
                      var timer;
                      return regenerator.wrap(function _callee3$(_context3) {
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              compiler.plugin("done", function () {
                                var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(stats) {
                                  return regenerator.wrap(function _callee2$(_context2) {
                                    while (1) {
                                      switch (_context2.prev = _context2.next) {
                                        case 0:
                                          clearTimeout(timer);
                                          timer = setTimeout(_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
                                            return regenerator.wrap(function _callee$(_context) {
                                              while (1) {
                                                switch (_context.prev = _context.next) {
                                                  case 0:
                                                    _context.next = 2;
                                                    return _this.her.defaultOptions.assetslog(stats);
                              ...
                              return _context3.abrupt("return", _this.webpackDev(compiler));
    ...
    value: function watchFiles() {
      ...
      this.her.builder.entries.forEach(function (_ref5) {
        var entryName = _ref5.entryName;
      ...
      var refreshFiles = _.debounce(_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
  ...
  _createClass(Her, [{
    ...
    value: function setConfig(options) {
      this.defaultOptions = defaultsDeep_1(options, {
        ...
        assetsPath: "__her__/",
        // 资源文件处理
        assetslog: function assetslog(state) {
