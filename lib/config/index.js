...
export default function (baseOption, builderOption) {
  return {
    ...
    resolve: defaultsDeep(baseOption.webpack.resolve, {
    ...
    module: {
      ...
      rules: [
        ...
        { test: /\.sass$/, use: styleLoader(baseOption, 'sass', [{ loader: 'sass-loader', options: { indentedSyntax: true } }, 'sass-resources-loader']) },
        { test: /\.scss$/, use: styleLoader(baseOption, 'scss', ['sass-loader', 'sass-resources-loader']) },
